...
makefile.conf: 
	coq_makefile -o makefile *.vBridges_order.v *.vBridges_order2_AX.v *.vBridges_order2_LS.v *.vEuler.v *.vHeyting_field.v *.vHRw.v *.vHRw0.v *.vHRw0_basic_facts.v *.vHRw0_iso.v *.vHRwequal.v *.vHRwgt.v *.vHRwintegral.v *.vHRw_spec.v *.vLaugwitzSchmieden.v *.vLtac.v *.vLUB_proof_AX.v *.vLUB_proof_LS.v *.vLUB_spec.v *.vLUB_spec_AX.v *.vLUB_spec_LS.v *.vNumbers.v *.vNumbers_facts.v *.voAQAs.v *.vsequences_AX.v *.vsequences_LS.v *.vw.v *.vw_2n.v *.vw_n.v *.vw_n2.v
